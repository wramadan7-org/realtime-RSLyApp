            ...
            {myName && myPhone && (
               <>
                  <View style={styles.left}>
                     <TouchableOpacity style={styles.btnBack} onPress={() => navigation.navigate('ProfileFriend')}>
                        <Material name="arrow-back" size={25} color="white" />
                     </TouchableOpacity>
                     <TouchableOpacity style={styles.btnProfile}>
                        <Text style={styles.txtName}>{myName === null ? myPhone : myName}</Text>
                     </TouchableOpacity>
                  </View>
               </>
            )}
            ...
            {friend && friendPhone && (
               <>
                  <View style={styles.left}>
                     ...
                     <TouchableOpacity style={styles.btnProfile}>
                        <Text style={styles.txtName}>{friend === null ? friendPhone : friend}</Text>
                     </TouchableOpacity>
                  </View>
               </>
            )}
