              ...
              <>
                ...
                <View style={styles.content}>
                  <TouchableOpacity style={styles.MediaFile}>
                    ...
                    <View style={styles.viewTotalFile}>
                      <Text style={styles.txtTotal}>17</Text>
                ...
                <View style={styles.content}>
                  <TouchableOpacity style={styles.btnOptions}>
                    <Text style={styles.desc}>Bisukan notifikasi</Text>
                    <Switch
                      ...
                      onValueChange={(value) =>
                        this.setState({switchMute: value})
                      }
                  ...
                  <TouchableOpacity style={styles.btnOptions}>
                    <Text style={styles.desc}>Notifikasi khusus</Text>
                  </TouchableOpacity>

                  <TouchableOpacity style={styles.btnOptions}>
                    <Text style={styles.desc}>Tampilkan media</Text>
                  </TouchableOpacity>
                </View>
                ...
                <View style={styles.content}>
                  <TouchableOpacity style={styles.btnEncript}>
                    <View style={styles.viewDesc}>
                      <Text style={styles.desc}>Enkripsi</Text>
                ...
                <View style={styles.content}>
                  <Text style={styles.titleGreen}>Nomor telepone</Text>
                  <TouchableOpacity style={styles.btnNumber}>
                    <View style={styles.viewDesc}>
                      <Text style={styles.desc}>+62 {data.phone}</Text>
                      <Text style={styles.subDesc}>Ponsel</Text>
                    </View>
                ...
                <View style={styles.content}>
                  <View style={styles.titleGroupt}>
                    <Text style={styles.titleGreen}>Grup yang sama</Text>
                    <Text style={styles.txtTotal}>2</Text>
                  </View>
                  ...
                  <TouchableOpacity style={styles.btnGrup}>
                    ...
                    <View style={styles.viewDescGrup}>
                      <Text style={styles.desc}>ALUMNI XII RPL</Text>
                  ...
                  <TouchableOpacity style={styles.btnGrup}>
                    ...
                    <View style={styles.viewDescGrup}>
                      <Text style={styles.desc}>XII RPL INFO</Text>
                      <Text style={styles.namePerson}>
                        Ahmad, Alda, Apip, Bagus, Bin, Bob, Boy Apip, Bagus,
                        Bin, Bob, Boy
                      </Text>
                    </View>
                  </TouchableOpacity>
                ...
                <View style={styles.content}>
                  <TouchableOpacity style={styles.btnRed}>
                    ...
                    <View style={styles.viewRed}>
                      <Text style={styles.txtRed}>Blokir</Text>
                    </View>
                  </TouchableOpacity>
                </View>
                ...
                <View style={styles.content}>
                  <TouchableOpacity style={styles.btnRed}>
                    ...
                    <View style={styles.viewRed}>
                      <Text style={styles.txtRed}>Laporkan kontak</Text>
                    </View>
                  </TouchableOpacity>
                </View>
              </>
